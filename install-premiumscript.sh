...
cd /usr/local/bin
wget -O premium-script.tar.gz "https://raw.githubusercontent.com/nadarekyoko/VPSmclick/master/premium-script.tar.gz"
...
chmod +x /usr/local/bin/mclick_others
chmod +x /usr/local/bin/mclick_pptp
chmod +x /usr/local/bin/mclick_sshovpn
chmod +x /usr/local/bin/mclick_vpssection
...
echo  "         	Updated Script created by  Rommel Pangilinan	       "
echo 
echo 
